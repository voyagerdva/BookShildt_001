package e0017_Arrays_max_size;

public class ArrayMax {
    public static void main(String[] args) {
        int sizeB = 2_147_483_645;  // +
        int sizeS = 2_147_483_645;  // +
        int sizeI = 1_567_621_116;  // +
        int sizeL = 783_810_558;    // +
...
//        for (int i = 0; i < sizeB / 3; i++) {
//            arrB[i] = (byte) i;
//        }

//        System.out.println("arr[max] = " + arr[size-1]);
    }
}
